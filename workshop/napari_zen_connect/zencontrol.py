...
class ZenExperiment():
    def __init__(self, experiment: str ='test.czexp',
...
class ZenDocuments():
    ...
    def getfilenames(self, folder: str = r'c:\temp',
                     pattern: str = "*.czexp") -> Tuple[str, str]:
...
class ZenTCPIP():
    ...
    def tcp_open_port(self, timeout: int = 200, port: int = 52767) -> Union[telnetlib.Telnet, int]:
    ...
    def tcp_eval_expression_and_wait_for_ok(self, telnet: telnetlib.Telnet,
                                            expression: str,
